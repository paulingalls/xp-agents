...
| **PreToolUse** (Skill) | Inject the skill's own preload state (`preload_injection.py`) — the sole channel by which a skill receives it; plus per-skill review guidance | Coding Standards, Communication |
