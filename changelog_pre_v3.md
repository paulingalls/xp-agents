# Changelog — pre-v3 archive

Archived entries for plugin versions **prior to v3.0.0**. Active CHANGELOG.md retains v3.x and forward; this file is the long-form historical record for v2.x and earlier.
