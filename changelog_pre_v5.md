...
Archived entries for plugin versions **v4.0.0 through v4.19.0**. The active
[`CHANGELOG.md`](CHANGELOG.md) retains v5.0 and forward; history prior to v4.0
lives in [`changelog_pre_v4.md`](changelog_pre_v4.md).
