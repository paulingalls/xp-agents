...
# an authored one inherits nothing, which is why that pin has a second leg over
# the DERIVED manifest (test_all_variant_hook_scripts_exist in
# tests/hooks/test_plugin_integrity_structure_and_close.py). An authored command
# naming a script that does not exist reddens there.
