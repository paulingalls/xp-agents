...
# Install/identity-verify/verify phase group lives in scaffold_verify.py
# (extracted to keep this module under the 500-line cap). Re-exported here
# by identity so apply_plan's orchestration and every existing import site /
# mock.patch target keep resolving through scaffold_apply unedited.
from scaffold_verify import (  # noqa: E402
    IDENTITY_PATTERN_REQUIRED_MSG,
    IDENTITY_VERIFY_TIMEOUT_SEC,
    INSTALL_TIMEOUT_SEC,
    VERIFY_TIMEOUT_SEC,
    run_install,
    run_verify,
