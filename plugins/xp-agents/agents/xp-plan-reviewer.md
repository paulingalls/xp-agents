...
**2b. Commit Cadence** — Each green phase needs a commit step. Multiple red/green cycles without a commit between them → flag. Commits trigger the review cycle (/simplify, /xp-quality-review); skipping commits skips quality checks.
