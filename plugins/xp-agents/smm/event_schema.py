...
# ---------------------------------------------------------------------------
# EVENT_TYPE_* constants live in event_categories.py (split for module size
# management) and are re-exported below by identity so every existing
# `event_schema.EVENT_TYPE_*` reference keeps working unchanged.
from event_categories import (  # noqa: E402, F401
    _EVENT_CATEGORY_MAP,
    EVENT_CATEGORY,
    EVENT_TYPE_ANSWER,
