...
EVENT_TYPE_KICKOFF_STARTED = "kickoff_started"
...
_EVENT_CATEGORY_MAP: dict[str, EVENT_CATEGORY] = {
    ...
    EVENT_TYPE_KICKOFF_STARTED: EVENT_CATEGORY.SIBLING_ARTIFACT,
...
_TYPE_ALLOWED_KEYS: dict[str, frozenset[str]] = {
    ...
    EVENT_TYPE_KICKOFF_STARTED: _UNIVERSAL_KEYS,
