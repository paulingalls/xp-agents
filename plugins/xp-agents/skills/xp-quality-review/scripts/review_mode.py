...
same resolution the per-commit gate uses, so the read keys match the writer.
The preload passes --cwd "${TEAMMATE_CWD:-.}" — the closing-story worktree at
story-close, else the main checkout.
"""
