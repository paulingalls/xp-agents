...
Surface the `### UNCOMMITTED` value to the user verbatim. The count is concerns/debts/discoveries newer than the last commit event — items not yet linked to a commit via `Resolves-Event:` trailer.
