...
If you are the main agent and see this: do not do this work yourself. This skill must run as the xp-spawn-team subagent. The subagent result is returned as a tool result which is NOT visible to the user — you must output the key findings as text in your response.
