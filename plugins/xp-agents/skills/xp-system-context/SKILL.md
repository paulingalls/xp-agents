...
This skill should run as a forked subagent (xp-system-analyzer). Your agent definition contains all instructions — follow them, analyze the codebase, write system_context.md, and then report back your summary to the main agent.
