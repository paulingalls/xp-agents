...
discovery mechanics plus the shared ``_DiscoveryTestCase`` base; this file holds
the per-language layout suites. The shared base and ``_touch`` helper are
imported from test_sister_tests so exactly one definition exists.
"""
