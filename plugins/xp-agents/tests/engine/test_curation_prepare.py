#!/usr/bin/env python3
"""Tests for materialize.prepare_curation_data(): SMM materialization for the
housekeeper curation prompt.

Split from test_curation.py to keep both files under the 500-line cap.
TestExtractRetroHistory, TestRenderMarkdownInsensitiveToEventBudgets, and
TestCurationInputSizeBound live in test_curation_retro_bounds.py. Helper
function tests (bulk append, atomic writes) in test_append_helpers.py.
"""
