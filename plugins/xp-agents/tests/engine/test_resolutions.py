#!/usr/bin/env python3
"""Tests for the metadata.resolves resolution mechanism.

Split from test_parse.py — covers TestMetadataResolves, TestRetroTryResolution,
TestMetadataResolvesEndToEnd. Cascade resolution tests live in
test_resolutions_cascade.py; event-reading tests live in
test_resolutions_read_events.py.
"""
