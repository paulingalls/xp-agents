...
Split at 551 lines: the story-009 HEAD-moved trace moved to
test_commit_head_moved_trace.py. What stays is the builder's output shape and the
message extraction underneath it.
"""
