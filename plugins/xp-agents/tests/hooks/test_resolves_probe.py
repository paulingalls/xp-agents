#!/usr/bin/env python3
"""Tests for resolves_probe.py candidate selection.

Covers find_probe_candidates (keyword/file-overlap/recency/close-mode
scoring), build_nudge_lines, emit_probe_status, sorting/tie-break,
selection-reason vocabulary, in-sprint-batch + discovery axes, and the
file-overlap normalizer. Snapshot-staleness + refresh-sentinel reload
tests live in test_resolves_probe_staleness.py.
"""
