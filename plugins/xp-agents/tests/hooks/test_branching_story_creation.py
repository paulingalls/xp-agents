#!/usr/bin/env python3
"""Tests for branching.create_story_branch — story-branch creation/resume in git.

Split at 500 lines: how the created name is recorded back onto the story, and
resumed from that record, is in test_branching_story_recording.py.
"""
