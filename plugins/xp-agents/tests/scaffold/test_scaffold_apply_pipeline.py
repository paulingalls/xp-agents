#!/usr/bin/env python3
"""Tests for scaffold_apply.py — happy-path pipeline + atomic revert.

Covers apply_plan happy path and the four revert paths
(install / verify / write / revert-of-revert failures). Defines the
shared `_plan`, `_ApplyTestBase`, `_RevertTestBase` fixtures used by
the validation/lifecycle sibling file (test_scaffold_apply_validation.py).
"""
